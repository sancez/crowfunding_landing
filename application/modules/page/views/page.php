                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="col-12 p-5 shadow">
                                        <h1 class="bold"><?php echo $content->name; ?></h1>
                                        <label>Terakhir diperbaharui <b><?php echo date("d M Y", strtotime($content->updated_at)); ?></b>&nbsp;<b style="font-size: 13px !important;"><?php echo date("H:i", strtotime($content->updated_at)); ?></b></label>
                                    </div>
