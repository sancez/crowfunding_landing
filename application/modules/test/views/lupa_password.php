                            ...
                            <div class="col-lg-6">
                                <div class="card m-b-30" style="border: none;">
                                    ...
                                    <div class="col-12 pl-5 pr-5 pb-5">
                                        <form id="FrmLinkResetPassword" class="subscribe-form form-hubungi-kami" role="form" method="POST" action="/pemodal/ajax_pemodal" style="visibility: visible;" autocomplete="off">
